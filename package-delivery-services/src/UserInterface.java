...
public class UserInterface extends JFrame implements ActionListener{
    ...
    private JLabel senderLabel, senderBlankLabel, recipientBlankLabel, recipientLabel, weightLabel, costLabel, additionalFeeLabel, flatFeeLabel,
    ...
    public UserInterface() {
        ...
        this.add(radioPanel);
        this.setTitle("Ivon's delivery services");
